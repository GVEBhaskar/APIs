...
public class FetchLinkUsageNoOrderId {
	@Test  /*Verifying fetchLinkUsage without OrderID*/
	public void verifyfetchLikUsagewithoutOrderID()
	{
		...
		Assert.assertEquals(jsonPath.get("errorMessage"), "Parameter orderID is required for function fetchLinkUsage, but no value was provided");
